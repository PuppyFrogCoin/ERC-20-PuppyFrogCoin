...
/// @custom:security-contact info@puppyfrogcoin.com
contract PuppyFrogCoin is ERC20, ERC20Burnable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    constructor() ERC20("PuppyFrog Coin", "PUPS") ERC20Permit("PuppyFrog Coin") {
        _mint(msg.sender, 777699669699001 * 10 ** decimals());
    }
